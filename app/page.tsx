          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-white p-6 rounded-lg shadow-md">
                ...
                <h3 className="text-xl font-semibold mb-2">Moderator Management</h3>
                <p className="text-gray-600">Create, update, and manage moderator accounts with ease.</p>
              </div>
              ...
              <div className="bg-white p-6 rounded-lg shadow-md">
                ...
                <p className="text-gray-600">Add and manage music tracks for each moderator.</p>
              </div>
              ...
              <div className="bg-white p-6 rounded-lg shadow-md">
                ...
                <p className="text-gray-600">JWT-based authentication with protected routes.</p>
              </div>
            </div>
          </div>
        </section>
