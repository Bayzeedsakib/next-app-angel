    ...
    <div className="min-h-screen flex flex-col bg-gray-50">
      ...
      <main className="flex-1 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 w-full">
        <div className="mb-8">
          ...
          <p className="text-gray-600">Welcome to your moderator management dashboard</p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-8">
          <Card>
            <CardBody className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold text-gray-900">{moderators.length}</p>
              </div>
          ...
          <Card>
            <CardBody className="flex items-center justify-between">
              <div>
                <p className="text-sm text-gray-600 mb-1">Inactive Moderators</p>
                <p className="text-3xl font-bold text-gray-600">
                  {moderators.filter((m: any) => m.status === 'inactive').length}
                </p>
              </div>
        ...
        <Card className="mb-8">
          ...
          <CardBody>
            <div className="grid md:grid-cols-2 gap-4">
              ...
              >
                <h3 className="font-semibold text-gray-900 mb-1">View All Moderators</h3>
                <p className="text-sm text-gray-600">Browse and manage moderator accounts</p>
              </Link>
              <Link
                href="/register"
                className="p-4 border-2 border-purple-200 rounded-lg hover:border-purple-400 hover:bg-purple-50 transition"
              >
                <h3 className="font-semibold text-gray-900 mb-1">Add New Moderator</h3>
                <p className="text-sm text-gray-600">Register a new moderator account</p>
              </Link>
            </div>
          </CardBody>
        </Card>
